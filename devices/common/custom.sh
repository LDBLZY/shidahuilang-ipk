...
./scripts/feeds install -a -p dahuilang
./scripts/feeds install -a

sed -i 's/\(page\|e\)\?.acl_depends.*\?}//' `find package/feeds/dahuilang/luci-*/luasrc/controller/* -name "*.lua"`
sed -i 's/\/cgi-bin\/\(luci\|cgi-\)/\/\1/g' `find package/feeds/dahuilang/luci-*/ -name "*.lua" -or -name "*.htm*" -or -name "*.js"` &
sed -i 's/Os/O2/g' include/target.mk
#rm -rf ./feeds/packages/lang/golang
#svn co https://github.com/immortalwrt/packages/trunk/lang/golang feeds/packages/lang/golang

sed -i '/root:/c\root:$1$tTPCBw1t$ldzfp37h5lSpO9VXk4uUE\/:18336:0:99999:7:::' package/feeds/dahuilang/base-files/files/etc/shadow
...
sed -i \
	...
	package/feeds/dahuilang/*/Makefile
